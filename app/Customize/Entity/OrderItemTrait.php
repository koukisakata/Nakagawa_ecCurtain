 ...
 */
trait OrderItemTrait // 👈 ここが OrderItemTrait になっていることが超重要です！
{
    /**
    ...
    // データを取り出す・入れるためのメソッド
    public function getCurtainWidth()
    {
        return $this->curtain_width;
    }

    public function setCurtainWidth($curtain_width)
    {
        $this->curtain_width = $curtain_width;
        return $this;
    }

    public function getCurtainHeight()
    {
        return $this->curtain_height;
    }

    public function setCurtainHeight($curtain_height)
    {
        $this->curtain_height = $curtain_height;
        return $this;
    }

    public function getCurtainPleats()
    {
        return $this->curtain_pleats;
    }

    public function setCurtainPleats($curtain_pleats)
    {
        $this->curtain_pleats = $curtain_pleats;
        return $this;
    }

    public function getCurtainMemory()
    {
        return $this->curtain_memory;
    }

    public function setCurtainMemory($curtain_memory)
    {
        $this->curtain_memory = $curtain_memory;
        return $this;
    }

    public function getCurtainPrice()
    {
        return $this->curtain_price;
    }

    public function setCurtainPrice($curtain_price)
    {
        $this->curtain_price = $curtain_price;
        return $this;
    }

    public function getCurtainOpen()
    {
        return $this->curtain_open;
    }

    public function setCurtainOpen($curtain_open)
    {
